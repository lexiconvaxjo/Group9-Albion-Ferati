...
namespace IdentityMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ApplicationUserManager userManager, ApplicationSignInManager signIn)
        {
        ...
        public ActionResult Index(string username, string password)
        {
            ...
            var status = SignIn.PasswordSignIn(username, password, false, false);
